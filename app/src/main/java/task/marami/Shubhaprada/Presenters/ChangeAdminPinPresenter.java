...
public class ChangeAdminPinPresenter implements IAdminPin.AdminPinPresenter {
    Context context;
    IAdminPin.AdminPinView adminPinView;
    public static int count=0;
    public ChangeAdminPinPresenter(Context context, IAdminPin.AdminPinView adminPinView) {
