...
public class ListLayoutPresenter implements IFListLayout.ListLayoutPresenter {
    Context context;
    IFListLayout.ListLayoutView listLayoutView;

    public ListLayoutPresenter(Context context, IFListLayout.ListLayoutView listLayoutView) {
    ...
    void ServerConnection(String url)
    {
        ...
        JsonArrayRequest arrayRequest=new JsonArrayRequest(Request.Method.POST, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                {
                    listLayoutView.onError("Ventures data Dosen't Exist");
                }
                else
                {
